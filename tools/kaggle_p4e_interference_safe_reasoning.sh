...
usage() {
  cat >&2 <<'EOF'
usage:
  tools/kaggle_p4e_interference_safe_reasoning.sh fresh|resume <p4e-i-final-dir> <p3-corpus-dir> [dev-suite]
...
WORK_DIR="/kaggle/working/p4e-k-work"
OUTPUT_DIR="/kaggle/working/p4e-k-final"
...
vn97-p4e-interference-safe-reasoning "${ARGS[@]}"
